...
try {
  // Skip installation check if CHROME_PATH is set (using custom Chrome)
  if (process.env.CHROME_PATH) {
    console.log(`Using custom Chrome: ${process.env.CHROME_PATH}`);
    console.log("Skipping Playwright Chromium installation check.");
  } else if (!isChromiumInstalled()) {
