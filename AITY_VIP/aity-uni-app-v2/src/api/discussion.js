 ...
 * @param {Array} data.images 图片列表 [{url, filename}]
 * @returns {Promise}
 */
 ...
 * @returns {Promise}
 */
export function updateReplyApi(id, replyId, data) {
  return put(`/discussions/${id}/replies/${replyId}`, data)
}
 ...
 * @returns {Promise}
 */
export function deleteReplyApi(id, replyId) {
  return del(`/discussions/${id}/replies/${replyId}`)
}
