...
const LOCAL_CERT_DIR = path.join('D:\\your-mcp-proxy\\99-个人探索\\AITY_VIP', 'aity88-online-new-cert', 'aity88.online_nginx');
...
async function run() {
  ...
  const deployScriptPath = path.join('D:\\your-mcp-proxy\\99-个人探索\\AITY_VIP', 'deploy-ssl-certificate.sh');
  const rollbackScriptPath = path.join('D:\\your-mcp-proxy\\99-个人探索\\AITY_VIP', 'deploy-rollback.sh');
