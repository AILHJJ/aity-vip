...
export const MESSAGE_TYPE_LABELS = {
  [MESSAGE_TYPES.POSITION_HANDLE]: '持仓',
  [MESSAGE_TYPES.PRE_MARKET_COMMENT]: '盘前',
  [MESSAGE_TYPES.MORNING_COMMENT]: '点评',
  [MESSAGE_TYPES.MORNING_FOCUS]: '盘中',
  [MESSAGE_TYPES.AFTERNOON_COMMENT]: '尾盘',
  [MESSAGE_TYPES.AFTERNOON_FOCUS]: '尾盘',
  [MESSAGE_TYPES.CLOSE_COMMENT]: '收盘',
  [MESSAGE_TYPES.RISK_WARNING]: '风险',
  [MESSAGE_TYPES.SYSTEM]: '系统',
  [MESSAGE_TYPES.IMPORTANT]: '重要',
  [MESSAGE_TYPES.DAILY]: '日常'
}
